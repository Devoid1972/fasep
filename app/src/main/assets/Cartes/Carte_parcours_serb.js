...
var cityjson = L.geoJSON(serbia_cities,{
   ...
   onEachFeature: function (feature, layer) {
        ...
        if (feature.properties.Indicator != null ) {
            titre = 'Fokus na indikatoru '+ feature.properties.Indicator_sb
        }
        layer.bindPopup('<h2><center>'+ feature.properties['name:sr-Latn'] +'</center></h2><hr>'
                                  ...
                                  + '</center></h2></br>'+ feature.properties.texte_sb, {'className' : 'popupCustom'});
   },
   pane: city_zone
}).addTo(map)
